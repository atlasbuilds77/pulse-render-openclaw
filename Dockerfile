...
RUN chmod +x /app/start.sh && mkdir -p /data /data/agents/pulse/sessions && chown -R node:node /data /app/pulse /app/workspace /app/openclaw.json /app/start.sh /app/pulse_api.py
USER node
